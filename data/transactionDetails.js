import * as itemsAPI from "./fakeGenreService";
...
export function saveTransactions(transaction) {
  ...
  TransactionHistory.price = priceAPI.price.find(g => g._id === transaction.priceId);
  TransactionHistory. = transaction.TransactionNo;
